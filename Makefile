...
run_dbt: ## Run dbt models
	poetry run dbt seed --profiles-dir handled_voice_interactions --project-dir handled_voice_interactions
	poetry run dbt run --profiles-dir handled_voice_interactions --project-dir handled_voice_interactions

run_dq_tests: ## Run data quality tests using dbt
	poetry run dbt test --profiles-dir handled_voice_interactions --project-dir handled_voice_interactions

run_catalog_server: ## Run dbt catalog server locally
	$(info Make: Generate dbt docs)
	poetry run dbt docs generate --profiles-dir handled_voice_interactions --project-dir handled_voice_interactions
	$(info Make: Run catalog server)
	poetry run dbt docs serve --profiles-dir handled_voice_interactions --project-dir handled_voice_interactions
